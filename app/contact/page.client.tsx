                ...
                <div> {/* Simplified div, as main now handles max-width and padding */}
                    {/* Hero Section */}                    <section className="text-center mb-16">
                        ...
                        <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto" itemProp="description">
                            we&apos;re here to help you transform your business with our{" "}                            <span className="font-semibold text-gray-800">{"{ai}"}</span> and{" "}
                            <span className="font-semibold text-gray-800">[blockchain solutions]</span>. get in touch with us for inquiries, support, or to learn more about how we can assist you.
                        </p>
                    </section>
                            ...
                            <h2 className="text-2xl font-semibold mb-6 lowercase text-gray-800 border-b pb-3">contact information</h2>
                              <div className="mb-6 p-4 bg-gray-50 rounded-md border border-gray-200 hover:shadow-md transition-shadow">
                                ...
                                <div className="pl-7">
                                    <p className="text-gray-600 mb-2">
                                        <span className="block text-gray-800 font-medium">phone:</span>                                        <a href="tel:+380956151756" className="text-gray-800 hover:text-black hover:underline transition-colors" itemProp="telephone">
                                            +380 95 615 1756
                                        </a>
                                    </p>
                                    <p className="text-gray-600">
                                        <span className="block text-gray-800 font-medium">email:</span>                                        <a href="mailto:info@fais.world" className="text-gray-800 hover:text-black hover:underline transition-colors" itemProp="email">
                                            info@fais.world
                                        </a>
                                    </p>
                                </div>
                              ...
                              <div className="mb-6 p-4 bg-gray-50 rounded-md border border-gray-200 hover:shadow-md transition-shadow">
                                ...
                                <div className="flex space-x-4 pl-7">
                                    <a href="https://twitter.com/fantasticaistudio" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800 transition-colors">
                                        <span className="sr-only">Twitter</span>
                                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                            <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                                        </svg>
                                    </a>
                                    <a href="https://linkedin.com/company/fantasticaistudio" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800 transition-colors">

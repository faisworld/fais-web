            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white text-gray-800" itemScope itemType="https://schema.org/ContactPage">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-neutral-800 text-white p-8 rounded-lg shadow-sm" itemScope itemType="https://schema.org/Organization">
                        ...
                        <div className="mb-8">
                            <h3 className="text-lg font-medium mb-2 lowercase">contact details</h3>                            <p className="text-gray-300 mb-2">
                                <span className="block text-white font-medium">phone:</span>
                                <a href="tel:+380956151756" className="hover:text-gray-300 transition-colors" itemProp="telephone">
                                    +380 95 615 1756
                                </a>
                            </p>
                            <p className="text-gray-300">
                                <span className="block text-white font-medium">email:</span>
                                <a href="mailto:info@fais.world" className="hover:text-gray-300 transition-colors" itemProp="email">
                                    info@fais.world
                                </a>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4">                                <a href="https://twitter.com/fantasticaistudio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors">
                                    <span className="sr-only">Twitter</span>
                                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                                    </svg>
                                </a>
                                <a href="https://linkedin.com/company/fantasticaistudio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors">

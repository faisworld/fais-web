      ...
      <section className='mb-12'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 text-center border border-neutral-200 transform hover:-translate-y-1'>
            <h3 className='text-xl font-semibold mb-2 lowercase text-neutral-800'>ecosystem</h3>
          ...
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 text-center border border-neutral-200 transform hover:-translate-y-1'>
            <h3 className='text-xl font-semibold mb-2 lowercase text-neutral-800'>expertise</h3>
            <p className='text-neutral-600 lowercase'>
          ...
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 text-center border border-neutral-200 transform hover:-translate-y-1'>
            <h3 className='text-xl font-semibold mb-2 lowercase text-neutral-800'>commitment</h3>
            <p className='text-neutral-600 lowercase'>
      ...
      <section className='mb-12'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>          
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col items-center text-center border border-neutral-200 transform hover:-translate-y-1'>
            ...
            />
            <h4 className='text-lg font-semibold mb-2 lowercase text-neutral-800'>dopple ai</h4>
            <p className='text-neutral-600 mb-3 lowercase flex-grow'>an ai-driven gaming platform that personalizes the gaming experience.</p>
            <a href='https://beta.dopple.ai/' className='button mt-auto' target='_blank' rel='noopener noreferrer'>website</a>
          </div>
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col items-center text-center border border-neutral-200 transform hover:-translate-y-1'>
            <Image
              ...
              className='rounded mb-4 w-full h-48 object-cover'
            />
            <h4 className='text-lg font-semibold mb-2 lowercase text-neutral-800'>degen kombat</h4>
            <p className='text-neutral-600 mb-3 lowercase flex-grow'>an action-packed blockchain game that combines gaming with decentralized finance.</p>
            <a href='https://degenkombat.com/' className='button mt-auto' target='_blank' rel='noopener noreferrer'>website</a>
          </div>
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col items-center text-center border border-neutral-200 transform hover:-translate-y-1'>
            <Image
              ...
              className='rounded mb-4 w-full h-48 object-cover'
            />
            <h4 className='text-lg font-semibold mb-2 lowercase text-neutral-800'>heroes of mavia</h4>
            <p className='text-neutral-600 mb-3 lowercase flex-grow'>a strategic base-building game powered by blockchain technology.</p>
            <a href='https://www.mavia.com/' className='button mt-auto' target='_blank' rel='noopener noreferrer'>website</a>
          </div>
        </div>
      </section>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col items-center text-center border border-neutral-200 transform hover:-translate-y-1'>
            <Image
              ...
              className='rounded mb-4 w-full h-48 object-cover'
            />
            <h4 className='text-lg font-semibold mb-2 lowercase text-neutral-800'>base.org</h4>
            <p className='text-neutral-600 mb-3 lowercase flex-grow'>
              base is built as an ethereum l2, decentralized with the optimism superchain, and incubated by coinbase.
            </p>
            <a href='https://www.base.org/' className='button mt-auto' target='_blank' rel='noopener noreferrer'>website</a>
          </div>
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col items-center text-center border border-neutral-200 transform hover:-translate-y-1'>
            <Image
              ...
              className='rounded mb-4 w-full h-48 object-cover'
            />
            <h4 className='text-lg font-semibold mb-2 lowercase text-neutral-800'>optimism.io</h4>
            <p className='text-neutral-600 mb-3 lowercase flex-grow'>
            ...
            <a href='https://www.optimism.io/' className='button mt-auto' target='_blank' rel='noopener noreferrer'>website</a>
          </div>
          <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col items-center text-center border border-neutral-200 transform hover:-translate-y-1'>
            <Image
              ...
              className='rounded mb-4 w-full h-48 object-cover'
            />
            <h4 className='text-lg font-semibold mb-2 lowercase text-neutral-800'>blast.io</h4>
            <p className='text-neutral-600 mb-3 lowercase flex-grow'>
              the only evm chain with native yield for eth and stablecoins.
            </p>
            <a href='http://blast.io/' className='button mt-auto' target='_blank' rel='noopener noreferrer'>website</a>
          </div>
        </div>
      </section>      
        ...
        <div className='max-w-7xl mx-auto px-4'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8 text-center'>
            <div className='bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-200'>
              ...
              <p className='text-neutral-600 lowercase font-medium text-sm leading-relaxed'>ai & blockchain projects delivered</p>
            </div>
            <div className='bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-200'>
              <div className='text-4xl font-bold text-neutral-800 mb-3'>
                <AnimatedCounter end={8} suffix='+' duration={1200} delay={200} />
              </div>
              <p className='text-neutral-600 lowercase font-medium text-sm leading-relaxed'>years of programming</p>
            </div>
            <div className='bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-200'>
              <div className='text-4xl font-bold text-neutral-800 mb-3'>
                <AnimatedCounter end={60} prefix='>' suffix='%' duration={1500} delay={400} />
              </div>
              <p className='text-neutral-600 lowercase font-medium text-sm leading-relaxed'>profitability growth</p>
            </div>
            <div className='bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-200'>
              <div className='text-4xl font-bold text-neutral-800 mb-3'>

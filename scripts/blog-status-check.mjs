...
async function checkBlogStatus() {
  ...
  try {
    ...
    const stabilityImages = posts.filter(post => 
      post.coverImage.includes('stability-ai-stable-diffusion-3')
    );
    
    console.log(`\n🎨 IMAGE QUALITY BREAKDOWN:`);
    console.log(`   ✅ Premium Images (Google Imagen 4/Flux 1.1 Pro): ${premiumImages.length}`);
    console.log(`   ⚠️  Old Stability AI Images: ${stabilityImages.length}`);

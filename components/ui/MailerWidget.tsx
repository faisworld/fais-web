            ...
            <form onSubmit={handleSubmit} className="mailer-widget max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
                {status === "success" && (
                    <div className="mb-4 p-3 bg-green-100 text-green-800 rounded-md">
                        Your message has been sent successfully! We&apos;ll get back to you soon. {/* Escaped apostrophe */}
                    </div>
                )}
                ...
                <div className="mt-4 text-xs text-gray-500 text-center">
                    This form is protected by reCAPTCHA Enterprise to ensure you&apos;re not a bot. {/* Escaped apostrophe */}
                </div>
            </form>
        </div>
    );
